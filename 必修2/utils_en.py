...
def get_products_and_category():
    ...
    for product_name, product_info in products.items(): # 遍历每一个商品
        category = product_info.get('category') # 获取当前商品对应的类别
        if category: # 如果类别存在,那么就保存映射,类别-->对应的商品
...
def generate_output_string(data_list): # 生成助手回复的json字符串形式
    output_string = ""
